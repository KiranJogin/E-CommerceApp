...
def admin_dashboard():
    ...
    pending_orders = Order.query.filter_by(order_status="Pending").count()   # FIXED
    delivered_orders = Order.query.filter_by(order_status="Delivered").count()  # FIXED
...
def manage_orders():
    if request.method == "POST":
        ...
        order.order_status = new_status      # FIXED
        db.session.commit()
    ...
    if status_filter:
        query = query.filter_by(order_status=status_filter)   # FIXED
